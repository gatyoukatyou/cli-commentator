...
`pubkey` must be the actual public-key text. The placeholder value in this repository must be replaced before production release.
...
- Replace updater public-key placeholder with the actual key
